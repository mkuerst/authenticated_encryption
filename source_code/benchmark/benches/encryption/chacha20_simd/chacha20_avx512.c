...
inline void PartialXor(const __m512i val, uint8_t *Src, uint8_t *Dest,
                       uint64_t Size) {
...
void ChaCha20EncryptBytes(uint8_t *restrict state, const uint8_t *restrict In,
                          uint8_t *restrict Out, uint64_t Size) {
